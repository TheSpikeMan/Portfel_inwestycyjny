...
# 0. Import biblioteki do wykomentowania w Cloud Functions
...
Aktywator Eventarc:
    ...
    - Dostawca zdarzeń: Big Query
    - Zdarzenie: google.cloud.bigquery.v2.JobService.Insert.Job
    - Zasób: Okreslony zasób
    - Pełna nazwa zasobu: projects/projekt-inwestycyjny/datasets/Dane_instrumentow/tables/Instruments
    - Region: europe-central2 (Warszawa)
    - Konto usługi: Default compute service account
