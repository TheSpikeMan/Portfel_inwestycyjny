...
W tej chwili w projekcie funkcjonują dwa moduły przetwarzające dane giełdowe:
...
Oba moduły zaprezentowane napisane są w języku Python i przetwarzane przez mechanizmy chmurowe Google każdego wieczoru. Zasada działania mechanizmów scrapujących dane jest następująca:
...
Tabele niezbędne do działania obydwu funkcji to:
